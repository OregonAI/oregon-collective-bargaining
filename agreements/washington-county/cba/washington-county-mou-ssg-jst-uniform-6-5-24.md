...
id: washington-county-mou-ssg-jst-uniform-6-5-24
title: Washington County — MOU_SSG_JST Uniform 6-5-24
doc_type: collective_bargaining_agreement
citation: Washington County MOU_SSG_JST Uniform 6-5-24 agreement
...
source_url: https://www.washingtoncountyor.gov/hr/documents/moussgjst-uniform-6-5-24/download?inline
source_format: pdf
retrieved: '2026-08-02'
source_sha256: 55471f516187a25dfeaf2cd2cf0df5b7b0ee08978640e6da9ce2a1b977337b28
...
conversion_notes: no text layer in the source PDF; text recovered by OCR. Two independent
  ...
  94% of the 17 figures, 99% dictionary-recognizable; NOT human-verified — treat every number
...
> source: <https://www.washingtoncountyor.gov/hr/documents/moussgjst-uniform-6-5-24/download?inline> (retrieved 2026-08-02).

# Washington County — MOU_SSG_JST Uniform 6-5-24

## At a glance

Collective bargaining agreement between **Washington County** and **the signatory association**.
- Listed on the county's labor agreements index as: “MOU_SSG_JST Uniform 6-5-24” (index archived in `_meta/discovery/`)
...
Extraction: no text layer in the source PDF; text recovered by OCR. Two independent engines (tesseract (ocrmypdf) + paddleocr PP-OCRv6) agree on 98% of the word sequence and 94% of the 17 figures, 99% dictionary-recognizable; NOT human-verified — treat every number as unchecked against the source.
