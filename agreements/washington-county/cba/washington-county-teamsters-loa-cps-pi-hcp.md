...
id: washington-county-teamsters-loa-cps-pi-hcp
title: Washington County — Teamsters LOA_CPS PI HCP
...
source_url: https://www.washingtoncountyor.gov/hr/documents/teamsters-loacps-pi-hcp/download?inline
source_format: pdf
retrieved: '2026-08-02'
source_sha256: 14effc75bd4f677dc9135f619d0dbe0ef95c5585999da8af49c426c9ac57b81b
snapshot_policy: hash-only
status: current
content_mode: summary
reproduction_basis: 'jointly-authored contract; summary + official link per the class determination
  in corpus.yml schema.doc_types (verbatim: false)'
conversion_notes: pdftotext -layout; 2 pages, 5104 characters extracted; NOT human-verified
last_verified: ''
verified_by: ''
...
> source: <https://www.washingtoncountyor.gov/hr/documents/teamsters-loacps-pi-hcp/download?inline> (retrieved 2026-08-02).

# Washington County — Teamsters LOA_CPS PI HCP

## At a glance

Collective bargaining agreement between **Washington County** and **Teamsters**.
- Listed on the county's labor agreements index as: “Teamsters LOA_CPS PI HCP” (index archived in `_meta/discovery/`)
...
Extraction: pdftotext -layout; 2 pages, 5104 characters extracted; NOT human-verified.
