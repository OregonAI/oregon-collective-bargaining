...
jurisdiction: oregon
id: state-seiu-non-state-adult-foster-home-providers-2023-2025
title: SEIU Non State Adult Foster Home Providers 2023-2025
doc_type: collective_bargaining_agreement
citation: 2023-2025 SEIU Non State Adult Foster Home Providers agreement
...
source_url: https://www.oregon.gov/das/HR/CBA/SEIU%20Non%20State%20Adult%20Foster%20Home%20Providers%202023-2025.pdf
source_format: pdf
retrieved: '2026-08-02'
source_sha256: 4f334e4269f714c7d61152a04f3cdc6417a8a895bc95827bc8311b3256702b2d
...
conversion_notes: pdftotext -layout; 69 pages, 135338 characters extracted; NOT human-verified
last_verified: ''
verified_by: ''
...
> source: https://www.oregon.gov/das/HR/CBA/SEIU%20Non%20State%20Adult%20Foster%20Home%20Providers%202023-2025.pdf (retrieved 2026-08-02).

# SEIU Non State Adult Foster Home Providers 2023-2025

## At a glance

**SUPERSEDED — an expired term, retained for the record.** A successor for this unit has been ratified per the LRU 2025-2027 bargaining chart (2026-01-27). If no successor document is linked below, the executed successor text has not yet been posted by DAS and this is the latest posted executed agreement — expired is not absent, and this text is not the current terms.
Collective bargaining agreement between the State of Oregon (DAS Labor Relations) and **SEIU** for the **2023-2025** term.
- Bargaining unit (LRU chart): SEIU Adult Foster Care and Relative Care
...
- Source document: 69 pages (PDF, DAS CBA library)
...
Extraction: pdftotext -layout; 69 pages, 135338 characters extracted; NOT human-verified.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement
                                                     TABLE OF CONTENTS
...
ARTICLE 9 – SERVICE FEES .................................................................................................... 19
   ...
   9.3 RESIDENT SERVICE RATES AND SUPPORT NEEDS ............................................ 24


2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement
   9.4 SERVICE PAYMENTS FOR AFH SERVING INDIVIDUALS IN THE
       BEHAVIORAL HEALTH SYSTEM ............................................................................. 25
   9.5 SERVICE PAYMENTS FOR AFH PROVIDERS ......................................................... 26
   9.6 PAYMENTS FOR DAYS OF SERVICE ...................................................................... 26
   9.7 TRAINING AND MATERIALS .................................................................................... 27
   9.8 NOTIFICATION OF PAYMENT SYSTEM CHANGES .............................................. 27
   9.9 CHANGES TO SERVICE PLAN AND PAYMENTS .................................................. 27
   9.10 ASSESSMENT REVIEWS ........................................................................................... 28
   9.11 NOTIFICATION TO PROVIDERS ............................................................................. 29
   9.12 OVERPAYMENTS....................................................................................................... 29
   9.13 OREGON MINIMUM WAGE COMPLIANCE .......................................................... 30
   9.14 COST OF LIVING ADJUSTMENT ............................................................................ 30
   9.15 RESIDENT MANAGER SCHEDULES ..................................................................... 31
   9.16 ADMINISTRATIVE RULES ...................................................................................... 31
ARTICLE 10 – PRE-PLACEMENT PLANNING....................................................................... 32
   10.1 PRE-ADMISSION PROCESS ...................................................................................... 32
   10.2 PLACEMENT IN AN APD, OHA and ODDS ADULT FOSTER HOME ................. 32
   10.3 ADULT FOSTER HOME PROVIDER RESPONSIBILITIES .................................... 33
   10.4 PRIVATE PLACEMENTS ........................................................................................... 33
ARTICLE 11 – UNION REPRESENTATION ............................................................................ 34
   11.1 RIGHT TO UNION REPRESENTATION ................................................................... 34
   11.2. CONTESTED CASE HEARINGS .............................................................................. 34
   11.3 INVESTIGATION PROCESSES ................................................................................. 34
   11.4 CONFIDENTIALITY ................................................................................................... 34
   11.5 GRIEVANCE DEFINITION ........................................................................................ 35
   11.6 INVESTIGATION STATUS REQUESTS ................................................................... 35
   11.7 REVIEW OF CASE FILES ......................................................................................... 35
   11.8 PROTECTIVE SERVICE INVESTIGATIONS RESULTING IN SUBSTANTIATED
       FINDINGS ...................................................................................................................... 36
ARTICLE 12 - AFH PROVIDER COMPLAINT RESOLUTION PROCESS............................ 37
   12.1 COMPLAINT PROCESS PROCEDURE..................................................................... 37
   12.2 COMPLAINT PROCESS STAFFING ......................................................................... 37
   12.3 DATA TRACKING ...................................................................................................... 37
   12.4 ANNOUNCEMENTS TO PROVIDERS ..................................................................... 37
   12.5 LOCAL RESOLUTION................................................................................................ 38
   12.6 COMPLAINT SUBMISSION PROCESS .................................................................... 38
ARTICLE 13 – NO RETALIATION ........................................................................................... 39
   13.1 PROTECTED UNION ACTIVITIES ........................................................................... 39
   13.2 LEGAL AND CONTRACTUAL RIGHTS .................................................................. 39
   13.3 CLAIMS PROCESS...................................................................................................... 39
ARTICLE 14 – INSPECTION VISITS ........................................................................................ 40
ARTICLE 15 – SUBCONTRACTORS ....................................................................................... 41
ARTICLE 16 - LABOR MANAGEMENT COMMITTEE ......................................................... 42
ARTICLE 17 - STANDARDIZE CRIMINAL BACKGROUND CHECK PROCESS FOR ALL
      AFH PROVIDERS ........................................................................................................... 43
ARTICLE 18 – SPECIFIC NEEDS CONTRACTS ..................................................................... 44
LETTER OF AGREEMENT - JOINT CONTRACT TRAINING............................................... 45
LETTER OF AGREEMENT – SPECIFIC NEEDS CONTRACTS ............................................ 46

2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement
STATEMENT OF INTENT - TRAINING................................................................................... 47
LETTER OF AGREEMENT - RN DELEGATION ................................................................... 49
LETTER OF AGREEMENT – RATE STUDY ........................................................................... 50
...
APPENDIX B - Oregon Health Authority and Addictions and Mental Health Division Adult
     Foster Home Base Rate and Add-Ons Table .................................................................... 61
APPENDIX C - Service Rates for Adult Foster Homes Serving Individuals in Aging and People
     with Disabilities Programs ................................................................................................ 64
CONTACT PAGE ........................................................................................................................ 67
SIGNATURE PAGE – TO BE INSERTED................................................................................. 68
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   5
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement               6
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   7
### ARTICLE 3 – TERM OF AGREEMENT

3.1 EFFECTIVE DATE.
Unless otherwise noted in a specific article in the Agreement, this Agreement becomes effective on the
date of ratification and expires June 30, 2025. The Union shall send a communication informing the
...
Negotiations for a successor agreement shall commence during the first (1st) full week of March 2025,
or such other date as may be mutually agreed upon, in writing, by the Parties. The Parties shall present
...
for April, May, June and July unless mutually agreed upon otherwise, in writing, at that meeting.



3.5 MEDIATION AND BINDING ARBITRATION.
Either Party may invoke mediation on or after June 30th of 2025 and any subsequent bargaining session
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   8
3.6 AGREEMENT EXTENSION.
If the Parties fail to reach agreement on a new successor Agreement on or before June 30, 2025, the
Agreement shall be automatically extended until a new Agreement is reached or an opinion and order
is promulgated pursuant to ORS 243.746(5).
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   9
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   10
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   11
...
continuing education trainings, and scheduled group orientations for Adult Foster Home Providers or
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   12
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   13
...
a) The Informal resolution shall conclude within fourteen (14) calendar days, unless mutually agreed
          ...
          the issue may be formally grieved by either the grievant or the Union.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   14
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   15
       Arbitrator List Modifications. The Parties may elect, during periods when the Agreement is open,
       ...
       process and any change in the timelines and procedures during mediation shall occur only upon
       mutual agreement, in writing.




2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   16
7.4 TIME LIMITS
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   17
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement           18
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   19
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement        20
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   21
...
(c)       Aging and People with Disabilities (APD). The CAPS assessment tool will be used
          for each person eligible through the APD delivery system. The rate will be paid
          based on the assessed need of the Individual. The rate is comprised of a base
          rate, add-ons and exceptions, if applicable. Appendix C provides the APD rate
          chart.


          Base Rate, Add-Ons and Exceptions (APD)
               • The term “base rate” means the payment amount due for providing basic
                    services to the Individual when the assessment does not indicate the need
                    for Add-ons or Exception payments. Add-ons means payment amounts due
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement      22
                    for providing specific additional services to clients based on the individual’s
                    assessed needs in accordance with the respective assessment tool. For
                    APD, “exceptions” means additional payments for needs not included in the
                    base rate or add-ons that require additional care and staff to meet the needs
                    of the individual. Questions about whether or not an activity is included in
                    the base rate should be directed to the local office first and, if not resolved,
                    through the AFH Provider Complaint Resolution Process.
               • Upon completion of an assessment and approval authorizing an add-on
                    payment, the add-on will be effective to the date of the assessment
                    supporting the need for the add-on.
               • Exceptional payments, as determined appropriate by the Agency, will be
                    approved on the date the provider submits the request and a staffing plan in
                    writing that justifies the exception and any other exceptions in the Adult
                    Foster Home, to the case manager at the AAA or APD office. If the provider
                    submits a staffing plan that does not justify the exception and other
                    exceptions in the Adult Foster Home, the provider will be given fourteen (14)
                    days to submit a staffing plan that will be approved by the ODHS or the
                    exception may be denied.
               • Denials of exceptions shall be in writing stating the specific reason(s) for the
                    denial.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement      23
...
(h)       For OHA AFH Providers a copy of the Individual’s Mental Health Assessment and the Individual’s
          LOCUS and LSI including the total and composite scores for each tool shall be given at the time
          of the assessment.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   24
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   25
...
(b)       For OHA Only: See Letter of Agreement – Service Payments for OHA Non-Medicaid Consumers


(c)       For ODDS only: Payment for AFH Providers is paid through the eXPRS payment system,
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   26
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   27
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement     28
...
(b)       assessment. ODHS/OHA will respond within two (2) weeks of the written request. Contact
          ...
          ODHS/OHA designated complaint contact.


(c)       If the Provider feels the issue is not resolved, they may initiate the complaint process within thirty
          (30) days of the ODHS/OHA response.


(d)       Rate Change Explanation. If an Individual’s rate increases or decreases based on change of
          ...
          contact within thirty (30) days of the completed assessment. ODHS/OHA will respond within two
          (2) weeks of the written request. ODHS/OHA will create a designated email for these requests.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   29
...
Effective December 1, 2023, the service payments of all Providers in Appendixes A,B and C shall be
increased by five percent (5%).
Effective January 1, 2025, the service payments of all Providers in Appendixes A, B, and C shall be
increased by four and one half percent (4.5%).


The COLAS for all Provider types shall be added to the previous agreement’s rates.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   30
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   31
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement       32
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   33
...
ability of the licensing authority or its designee to conduct or complete the activities outlined above and
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement        34
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   35
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   36
...
to the Provider acknowledging the complaint has been received and the expected timeline for an initial
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   37
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   38
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   39
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   40
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   41
...
established. The Committee shall take steps to ensure consistency with the Collective Bargaining
...
Agreement shall not be implemented until a Letter of Agreement has been signed by the ODHS Labor
Representative and the Executive Director of the SEIU Local 503, OPEU.
...
The Committee shall meet when necessary, but not more than once each calendar quarter, unless
...
Licensing Entity shall be invited to join the meeting for this portion of the agenda.
                                                                                        NEW: 2021 REV: 2023
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   42
...
(ORCHARDS) checks and provide preliminary approval in a prompt manner. Providers are then able
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   43
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   44
...
To that end, after the Collective Bargaining Agreement is ratified, the intent of the Parties is to
collaborate to present training to the key staff and partners.




2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   45
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   46
...
B.     Based on a shared understanding that quality training enhances skills and improves services
       ...
       4.      Communicate approved training opportunities through provider alerts which can be
               ...
               2024.
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement       47
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   48
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   49
### LETTER OF AGREEMENT – RATE STUDY
...
Recitals
The Department of Human Services has been directed to conduct a comprehensive rate and wage
study across home and community-based service delivery systems, with a focus on providers of in-
home and residential care to individuals receiving services through the Office of Development
Disabilities Services, the Office of Aging and People with Disabilities and provide a written report on
the findings and recommendations to the Joint Committee On Ways and Means or Emergency Board
no later than September 2024.


Rate Study
The State commits through this Agreement that Adult Foster Homes are fully engaged and included in
the rate and wage study and the data will be presented to the legislature in 2025 to highlight the
operating costs for Adult Foster Homes.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   50
### LETTER OF AGREEMENT - MH PROVIDERS AND IMPLEMENTATION OF 410
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   51
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   52
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement   53
### APPENDIX A - Rates for Adult Foster Homes Serving Individuals with Developmental
                                           Disabilities
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement         54
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement              55
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement              56
B) Medical Section:
...
Fire Evacuation            Full Assist                                      $          18.51    $       19.44   $      20.31
   ...
   Support Oral            Full Assist 7 or more                            $         381.12    $      400.18   $    418.18
    ...
    Medication
                           Partial Assist
   Management                                                               $         191.19    $      200.75   $    209.78
 Support Inhalants,
...
Supports - Complex             Full Assist & Monitoring Exclusive
   ...
   2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement             57
...
Vagal Stimulator                                                     $        65.30    $   68.57    $         71.65
  ...
  2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement       58
...
Needs Medical        Assists Ongoing Nightly                                         $   2,290.43     $    2,404.95       $        2,513.17
  ...
  2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement              59
D.) Behavioral Needs Section
...
Home                   Within Hearing & Visual distance                       $     763.48   $     801.65    $    837.73
      ...
      2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                                           60
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                                       61
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                         62
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                                   63
...
C.1 APD RATE TABLE
                                                           Rate Per Month
                                     Effective December 1, 2023      Effective January 1, 2025
Base                                 $                2,029.00 $                        2,120.00
Base plus 1 add-on                   $                2,398.00 $                        2,506.00
Base plus 2 add-ons                  $                2,767.00 $                        2,892.00
Base plus 3 add-ons                  $                3,136.00 $                        3,278.00
Add-on Rate                          $                  369.00 $                           386.00
                                                            Rate Per Hour
...
C.2 APD PAYMENTS
APD will pay a Base Rate with up to one (1) Add-on in each of the categories of: ADL,
Behavior and Complex Medical needs (three (3) Add-on Maximum).


Requests for payment for additional assessed needs which require staffing beyond
standard Add-ons must go through the exceptional rates process, be prior approved and
will be paid the additional hours of service rate in the rate table with proof of hiring and
continued employment.                  Changes to exceptional rates based on the change in the
“additional hours of service rate” will be updated at time of annual reassessment, or as a
change in condition occurs, based on Department approval of the exceptional needs
request. Exceptional hours shall adequately meet resident service needs and adequately
fund this service for Providers.


Based on the assessment of the Individual, by the State or its designee, APD may pay
pass-through funding for additional service/s for Individuals that are not included in the
AFH rate. Pass-through funding may be approved for non-ADL/IADL supports.




2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                                64
C.3 ADD ON CRITERIA
...
Specific Needs Contract and Exceptional Rates are outside of the standardized APD-
AFH rate structure and have their own distinct rate schedule defined below. Some of the
specific needs covered under these contracts include: Ventilator Dependent,
Neurological/Neuro-gerontologic, Brain Injury, Behavioral Needs, Bariatric, Complex
ADL, Enhanced Care Outreach Services, and Cognitive/Memory Care.
                                                           Rate Per Month
Target Population                    Effective December 1, 2023     Effective January 1, 2025
ECOS                                 $                3,665.00 $                       3,830.00
Basic                                $                8,180.00 $                       8,548.00
Advanced                             $                9,348.00 $                       9,769.00
Standard Ventilator                  $               11,688.00 $                      12,214.00
Complex                              $               12,006.00 $                      12,546.00
...
rate categories, depending on care and staffing needs of the Individuals served under
that contract.
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                              65
Specific Needs Provider Compliance Process:
By July 1, 2020 the State shall develop a checklist of items that will be reviewed during
the routine Contract Compliance Process.


Providers shall be notified thirty (30) days in advance of an upcoming compliance
process. Providers shall have fifteen (15) business days from initial notification of the
compliance process to provide requested documentation.


By July 1, 2020 the State shall provide Specific Need Providers access to example forms
for use in the SNP homes.
...
possesses an imminent risk to the Individual/s in the AFH, as determined by the State.
Providers will have no more than sixty (60) days to come into compliance before
termination of the Specific Needs Contract.


For multiple related occurrences of intentional non-compliance the State may terminate
the contract as specified in the Specific Needs Contract.


Appropriate transition plans including necessary funding through the exceptional rates
process will be made if the assessed needs of the Individual continue to demonstrate the
higher needs. The current Specific Needs Contract rate shall continue until Individuals
are transferred out of the AFH or an exceptional rate has been established, if necessary.
The Department retains sole discretion in determining Exceptional Rate and Specific
Need Contract Providers.




2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                      66
                                                    CONTACT PAGE
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                       67
           SIGNATURE PAGE – SEIU – ADULT FOSTER HOME PROVIDERS

                      Signed this 22 day of February 2024, at Salem, Oregon.
...
Berri Leslie, Director                               Nadja Gulley, State Labor Relations Manager
...
Melissa Unger, Executive Director                    Keith Quick, Collective Bargaining Coordinator
SEIU Local 503                                       SEIU Local 503


Rachel Hansen, Care Provider Employer
...
2023-2025 SEIU Local 503 AFH Signature Page
...
2023-2025 SEIU Adult Foster Home Collective Bargaining Agreement                               69

